...
- [1. KTCT Mác – Lênin ra đời như thế nào](#1-ktct-mác--lênin-ra-đời-như-thế-nào)
- [2. Đối tượng nghiên cứu](#2-đối-tượng-nghiên-cứu)
- [3. Mục đích và quy luật kinh tế](#3-mục-đích-và-quy-luật-kinh-tế)
- [4. Phương pháp nghiên cứu: trừu tượng hóa khoa học](#4-phương-pháp-nghiên-cứu-trừu-tượng-hóa-khoa-học)
- [5. Bốn chức năng của KTCT](#5-bốn-chức-năng-của-ktct)
...
## 1. KTCT Mác – Lênin ra đời như thế nào

Thuật ngữ "kinh tế chính trị" (*political economy*) xuất hiện **năm 1615** trong *Chuyên luận về kinh tế chính trị* của A. Montchrétien (Pháp) — nhưng mới là phác thảo. Phải đến thế kỷ XVIII, với **Adam Smith**, kinh tế chính trị mới chính thức thành môn học có phạm trù, khái niệm riêng (tr. 12).

Trước Mác, khoa học này đi qua **ba trường phái lớn**, mỗi trường phái tiến một bước nhưng vướng một hạn chế:

| Trường phái | Thời gian / đại biểu | Nghiên cứu khâu nào | Đóng góp | ⚠️ Hạn chế |
| --- | --- | --- | --- | --- |
| **Trọng thương** | giữa XV – giữa XVII; T. Mun, W. Stafford (Anh), Serra (Ý), Montchrétien (Pháp) | **lưu thông** (tư bản thương nghiệp đang thống trị) | nêu đúng mục đích nhà tư bản là **tìm lợi nhuận** | tưởng lợi nhuận sinh ra **từ thương nghiệp** (mua rẻ, bán đắt) |
| **Trọng nông** | Pháp, nửa cuối XVII – nửa đầu XVIII; Boisguillebert, **Quesnay**, Turgot | **sản xuất** (nhưng chỉ nông nghiệp) | luận giải nhiều phạm trù: giá trị, **sản phẩm ròng**, tư bản, tiền lương, lợi nhuận, tái sản xuất | tưởng **chỉ nông nghiệp** mới là sản xuất |
| **Cổ điển Anh** | cuối XVII – nửa đầu XIX; **Petty → A. Smith → D. Ricardo** | **tái sản xuất**, hệ thống hóa phạm trù | rút ra: **giá trị do hao phí lao động tạo ra**, giá trị khác của cải | chưa phân tích được nguồn gốc thực của lợi nhuận (xem 📚 dưới) |
...
- **Dòng 1** — khai thác các quan sát mang tính **tâm lý, hành vi** để xây dựng lý thuyết về hành vi người tiêu dùng, người sản xuất, và các "đại lượng lớn" của nền kinh tế; **không** đi sâu quan hệ xã hội. → phát triển thành **kinh tế học** ngày nay ở châu Âu, Bắc Mỹ.
- **Dòng 2** — từ **D. Ricardo**, đi sâu **quan hệ xã hội trong sản xuất**. **C. Mác (1818–1883)** kế thừa **trực tiếp** dòng này.
...
1. KTCT nghiên cứu **quan hệ giữa người với người** (quan hệ **sở hữu**; **quản lý**; **phân phối, phân bổ nguồn lực**; quan hệ trong **lưu thông**; trong **tiêu dùng**; trong **quản trị phát triển** quốc gia/địa phương…) — **không** nghiên cứu bản thân vật chất của LLSX, cũng **không** nghiên cứu biểu hiện cụ thể của KTTT, mà đặt các quan hệ ấy *trong liên hệ* với LLSX và KTTT (tr. 22–23).
...
| --- | --- | --- |
| Bản chất | **khách quan**, tồn tại độc lập ý chí con người | **chủ quan**, sản phẩm của con người |
...
## 4. Phương pháp nghiên cứu: trừu tượng hóa khoa học
...
## 5. Bốn chức năng của KTCT

| Chức năng | Nội dung (tr. 29–32) |
| --- | --- |
| **1. Nhận thức** | cung cấp hệ thống **tri thức, phạm trù** về quy luật của sản xuất – trao đổi; giúp nhìn **xuyên qua** bề mặt hỗn độn để thấy **quy luật** ở tầng sâu |
| **2. Thực tiễn** | biến nhận thức thành **năng lực vận dụng** quy luật vào lao động, hoạch định chính sách, quản trị → cải tạo thực tiễn, thúc đẩy văn minh |
...
| --- | --- |
| **Kinh tế chính trị** | khoa học kinh tế nghiên cứu **quan hệ kinh tế** để tìm **quy luật** chi phối các quá trình kinh tế (tr. 14) |
| **Chủ nghĩa trọng thương / trọng nông** | trường phái nghiên cứu **lưu thông** / **nông nghiệp** trước cổ điển Anh (tr. 13–14) |
| **KTCT cổ điển Anh** | Petty → Smith → Ricardo; nêu "giá trị do **hao phí lao động** tạo ra" (tr. 14) |
| **Tính hai mặt của lao động** | phát hiện của Mác, tiền đề của học thuyết giá trị thặng dư (học ở [bài 4](bai_04_gia_tri_thang_du_nguon_goc.md)) (tr. 16) |
| **Đối tượng của KTCT M-L** | các **quan hệ xã hội của sản xuất và trao đổi**, đặt trong liên hệ với LLSX và KTTT (tr. 22) |
| **Chỉnh thể bốn khâu** | sản xuất – lưu thông – phân phối – tiêu dùng (tr. 24) |
| **Quy luật kinh tế** | liên hệ **bản chất, khách quan, lặp lại** của các quá trình kinh tế; **có tính lịch sử** (tr. 25) |
| **Chính sách kinh tế** | sản phẩm **chủ quan** của con người, vận dụng quy luật; có thể sai và thay được (tr. 26) |
| **Trừu tượng hóa khoa học** | gạt bỏ cái ngẫu nhiên/tạm thời, tách ra cái điển hình/bền vững để nắm bản chất (tr. 28) |
| **Bốn chức năng** | nhận thức · thực tiễn · tư tưởng · phương pháp luận (tr. 29–32) |

---

## 7. Câu hỏi tự kiểm tra

1. KTCT Mác – Lênin hình thành qua những trường phái nào? Nêu **đóng góp và hạn chế** của trọng thương, trọng nông, cổ điển Anh.
2. Vì sao KTCT Mác – Lênin và kinh tế học hiện đại là **hai nhánh cùng một gốc** (A. Smith)? Chúng khác nhau ở **câu hỏi gốc** nào?
3. Vì sao Mác phải **kế thừa có phê phán** Ricardo? Nghịch lý lợi nhuận mà Ricardo bế tắc là gì?
4. Phát biểu **đối tượng nghiên cứu** của KTCT Mác – Lênin. Vì sao là "quan hệ giữa người với người", và vì sao là **chỉnh thể bốn khâu**?
5. Phân biệt KTCT theo **nghĩa hẹp** và **nghĩa rộng**. Vì sao KTCT "mang tính lịch sử"?
6. Phân biệt **quy luật kinh tế** và **chính sách kinh tế**. Lấy ví dụ **giá trần** để cho thấy "con người không thể thủ tiêu quy luật".
7. **Trừu tượng hóa khoa học** là gì? Vì sao là phương pháp *chủ yếu*? Nêu ví dụ về **giới hạn** của nó.
8. Nêu **bốn chức năng** của KTCT. Phân tích chức năng **phương pháp luận** qua ví dụ về tiền tệ.
...
```
BÀI 1 — ĐỐI TƯỢNG, PHƯƠNG PHÁP, CHỨC NĂNG CỦA KTCT M-L        (C1, tr. 11–33)
═══════════════════════════════════════════════════════════════════════════════
RA ĐỜI (3 trường phái trước Mác — mỗi cái tiến 1 bước, vướng 1 hạn chế):
  TRỌNG THƯƠNG(lưu thông; sai: lợi nhuận từ thương nghiệp)
  TRỌNG NÔNG(sản xuất; sai: chỉ nông nghiệp là sản xuất)
  CỔ ĐIỂN ANH Petty→Smith→Ricardo (giá trị = hao phí LAO ĐỘNG)
  → C.MÁC: phát hiện TÍNH HAI MẶT của lao động → GIÁ TRỊ THẶNG DƯ (bộ "Tư bản")
  → LÊNIN: độc quyền, quá độ ⇒ KTCT MÁC–LÊNIN
  * sau A.Smith rẽ 2 dòng: hành vi/đại lượng → KINH TẾ HỌC ‖ quan hệ SX → MÁC (CÙNG GỐC)
  📚 Ricardo bế tắc: trao đổi ngang giá sao có lợi nhuận? Mác gỡ = hàng hóa SỨC LAO ĐỘNG

ĐỐI TƯỢNG = QUAN HỆ XÃ HỘI CỦA SẢN XUẤT & TRAO ĐỔI (người–người), gắn LLSX & KTTT
  chỉnh thể 4 khâu: SẢN XUẤT – LƯU THÔNG – PHÂN PHỐI – TIÊU DÙNG
  nghĩa hẹp(1 phương thức SX) / nghĩa rộng(mọi thời đại) → KTCT MANG TÍNH LỊCH SỬ
  📚 khác Kinh tế học: KTCT hỏi "giá trị từ đâu, ai được–ai mất"; KTH hỏi "phân bổ nguồn lực khan hiếm"

MỤC ĐÍCH = phát hiện QUY LUẬT (bản chất, khách quan, lặp lại, CÓ TÍNH LỊCH SỬ)
  QUY LUẬT KT: khách quan, KHÔNG thủ tiêu được ‖ CHÍNH SÁCH KT: chủ quan, sửa được
  📚 ví dụ giá trần < giá cân bằng → THIẾU HỤT + chợ đen (quy luật "trả đũa")

PHƯƠNG PHÁP chủ yếu = TRỪU TƯỢNG HÓA KHOA HỌC ("phòng thí nghiệm bằng tư duy")
  gạt cái ngẫu nhiên/tạm thời → giữ cái điển hình/bền vững → nắm bản chất
  ⚠️ đúng GIỚI HẠN: không cắt nhầm bản chất (không bỏ yếu tố LỢI ÍCH)

4 CHỨC NĂNG: ① NHẬN THỨC ② THỰC TIỄN ③ TƯ TƯỞNG ④ PHƯƠNG PHÁP LUẬN
  (KTCT cấp cái GỐC, kinh tế học chuyên ngành mô tả cái NGỌN — vd: bản chất của tiền)

💼 QTKD: 2 lăng kính (KTCT + kinh tế học) · quản trị = quản trị QUAN HỆ lợi ích ·
   4 khâu = value chain · không có mô hình đúng cho mọi thị trường · chiến lược phải THUẬN quy luật ·
   trừu tượng hóa = kỹ năng mô hình hóa (đừng cắt nhầm biến quyết định)
═══════════════════════════════════════════════════════════════════════════════
```
...
- **Giáo trình Kinh tế chính trị Mác – Lênin** (hệ không chuyên), Bộ GD&ĐT, NXB Chính trị Quốc gia Sự thật,
  Hà Nội, 2021 (chủ biên PGS.TS. Ngô Tuấn Nghĩa) — **Chương 1** (tr. 11–33). [File gốc PDF](../tai_lieu/Giao-trinh-Kinh-te-chinh-tri-Mac-Lenin.pdf).
- Trích dẫn C. Mác, Ph. Ăngghen theo bản dẫn của giáo trình (*Toàn tập*, NXB Chính trị Quốc gia; nghĩa rộng: t.20, tr.207–208).
- Các mục **📚 Mở rộng** (cách mạng cận biên, phê phán Ricardo, quy luật kinh tế vs tự nhiên, ví dụ giá trần) và **💼 Góc QTKD** là phần biên soạn thêm, **không có trong sách** — để hiểu gốc và liên hệ ngành, không phải nội dung thi.
...
| # | Bài | Nguồn | Ưu tiên |
| ---: | --- | --- | :---: |
| **1** | **Đối tượng, phương pháp và chức năng của KTCT** ← *bạn đang ở đây* | C1 | 🎯 |
| 2 | Hàng hóa và tiền tệ | C2 | 🎯 |
| 3 | Thị trường và vai trò các chủ thể | C2 | 🎯 |
| 4 | Giá trị thặng dư — nguồn gốc | C3 | 🎯⭐ |
| 5 | Tích lũy tư bản; lợi nhuận – lợi tức – địa tô | C3 | 🎯⭐ |
| 6 | Cạnh tranh và độc quyền | C4 | 🎯 |
| 7 | Kinh tế thị trường định hướng XHCN ở Việt Nam | C5 | 🔸 |
| 8 | Công nghiệp hóa, hiện đại hóa và hội nhập kinh tế | C6 | 🔸 |

🎯 vòng 1 — học kỹ · 🔸 vòng 2 — đọc hiểu · ⭐ trọng tâm thi
Các bài 2–8 chưa soạn; sẽ thành link khi soạn xong.
