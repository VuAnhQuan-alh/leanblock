...
- [1. Sản xuất hàng hóa và hai điều kiện ra đời](#1-sản-xuất-hàng-hóa-và-hai-điều-kiện-ra-đời)
- [2. Hàng hóa và hai thuộc tính](#2-hàng-hóa-và-hai-thuộc-tính)
- [3. Tính hai mặt của lao động sản xuất hàng hóa](#3-tính-hai-mặt-của-lao-động-sản-xuất-hàng-hóa)
- [4. Lượng giá trị và các nhân tố ảnh hưởng](#4-lượng-giá-trị-và-các-nhân-tố-ảnh-hưởng)
- [5. Tiền tệ: nguồn gốc, bản chất, chức năng](#5-tiền-tệ-nguồn-gốc-bản-chất-chức-năng)
- [6. Dịch vụ và các "hàng hóa đặc biệt" ngày nay](#6-dịch-vụ-và-các-hàng-hóa-đặc-biệt-ngày-nay)
...
| Điều kiện | Nội dung | Vai trò |
| --- | --- | --- |
| **1. Phân công lao động xã hội** | chia lao động thành các ngành, nghề → mỗi người chỉ làm **một** thứ nhưng **cần nhiều** thứ → buộc phải trao đổi | điều kiện **cần** |
| **2. Sự tách biệt về mặt kinh tế** giữa các chủ thể (dựa trên **tách biệt về sở hữu**) | người sản xuất độc lập, **tách biệt về lợi ích** → muốn dùng sản phẩm của nhau phải **mua bán** | điều kiện **đủ** |
...
```
Xét quan hệ trao đổi:  x đơn vị hàng hóa A  =  y đơn vị hàng hóa B
Tỷ lệ này gọi là GIÁ TRỊ TRAO ĐỔI.
Hỏi: A và B công dụng khác hẳn nhau, sao trao đổi được theo tỷ lệ nhất định?
→ Gạt "giá trị sử dụng" sang bên, A và B còn MỘT điểm chung duy nhất:
   đều là SẢN PHẨM CỦA LAO ĐỘNG — một lượng lao động BẰNG NHAU đã hao phí.
...
| --- | --- | --- |
| **Giá trị** | lao động xã hội kết tinh trong hàng hóa | **nội dung**, bản chất, cơ sở |
...
Vì sao hàng hóa có **hai** thuộc tính? Vì **lao động sản xuất hàng hóa có tính hai mặt** — phát hiện **của riêng C. Mác** (tr. 40):

| Mặt của lao động | Định nghĩa | Tạo ra | Phản ánh tính chất |
| --- | --- | --- | --- |
...
## 4. Lượng giá trị và các nhân tố ảnh hưởng
...
**① Năng suất lao động** — quan hệ **tỷ lệ nghịch**. C. Mác: *"đại lượng giá trị của một hàng hóa thay đổi **tỷ lệ thuận** với lượng lao động thể hiện trong hàng hóa đó và **tỷ lệ nghịch** với sức sản xuất của lao động"* (*Toàn tập*, t.23, tr.69; dẫn tr. 44).

**② Cường độ lao động** — **không đổi** giá trị đơn vị. ⭐ **Đây là chỗ hay lẫn nhất** — so sánh bằng một ví dụ số:

```
GỐC:            8h lao động → 8 sản phẩm
                → mỗi sản phẩm = 8h/8 = 1h giá trị ; tổng = 8h

① TĂNG NĂNG SUẤT ×2 (cùng sức, khéo/máy tốt hơn):
                8h → 16 sản phẩm
                → mỗi sản phẩm = 8h/16 = 0,5h  ↓ GIÁ TRỊ ĐƠN VỊ GIẢM
                → tổng giá trị = 8h (KHÔNG đổi)

② TĂNG CƯỜNG ĐỘ ×2 (làm "đậm đặc" gấp đôi = như kéo dài ngày lao động):
                8h "đậm" = 16h hao phí → 16 sản phẩm
                → mỗi sản phẩm = 16h/16 = 1h  → GIÁ TRỊ ĐƠN VỊ KHÔNG ĐỔI
                → tổng giá trị = 16h (TĂNG gấp đôi)
```
...
## 5. Tiền tệ: nguồn gốc, bản chất, chức năng

Giá trị **trừu tượng**, không nhìn thấy được; nó chỉ **bộc lộ** qua **hình thái biểu hiện** trong trao đổi. Lịch sử các hình thái giá trị **chính là** lịch sử ra đời của tiền — trả lời câu hỏi *vì sao tiền mua được hàng* (tr. 46). **Bốn hình thái**:

```
① GIẢN ĐƠN / NGẪU NHIÊN:   1A = 2B
     (B là "vật ngang giá" đơn lẻ; trao đổi trực tiếp, ngẫu nhiên)
② ĐẦY ĐỦ / MỞ RỘNG:        1A = 2B  hoặc  8C  hoặc  5D ...
     (nhiều vật ngang giá; vẫn trao đổi trực tiếp, tỷ lệ chưa cố định)
③ CHUNG:                    2B; 3C; 5D ...  =  1A
     (mọi hàng hóa biểu hiện giá trị ở MỘT vật ngang giá chung A;
      nhưng mỗi vùng chọn một "A" khác nhau → cản trở trao đổi)
④ TIỀN:                     2B; 3C; 5D ...  =  0,1 gr VÀNG
...
| Chức năng | Nội dung | Yêu cầu về tiền |
| --- | --- | --- |
| **1. Thước đo giá trị** | đo & biểu hiện giá trị hàng hóa → sinh ra **giá cả** (*giá cả = biểu hiện bằng tiền của giá trị*) | chỉ cần **tưởng tượng**, không cần tiền mặt |
| **2. Phương tiện lưu thông** | môi giới mua – bán (H–T–H) | cần **tiền mặt**; **không** cần đủ giá trị → cơ sở phát hành **tiền giấy** |
| **3. Phương tiện cất trữ** | rút khỏi lưu thông để dành; tự điều tiết khối lượng tiền | phải **đủ giá trị** (vàng, bạc) |
...
## 6. Dịch vụ và các "hàng hóa đặc biệt" ngày nay

Phần này (tr. 52–55) là giáo trình **làm rõ thêm** những thứ thời Mác chưa bàn kỹ — rất sát ngành QTKD.

**Dịch vụ** cũng là **một loại hàng hóa, nhưng vô hình** (tr. 52): cũng do hao phí lao động tạo ra, cũng có giá trị và giá trị sử dụng. ⚠️ Khác hàng hóa thường: **không cất trữ được**, **sản xuất và tiêu dùng diễn ra đồng thời**. (Bác bỏ ngộ nhận "Mác chỉ biết hàng hóa vật thể".)

**Các yếu tố "khác hàng hóa thông thường"** — có giá cả, mua bán được, nhưng **không do hao phí lao động trực tiếp** tạo ra như hàng hóa thường (tr. 53–55):

| Yếu tố | Bản chất theo sách |
| --- | --- |
| **Quyền sử dụng đất** | có giá cả (do cung – cầu, đầu cơ, khan hiếm, đô thị hóa…) nhưng **không do lao động tạo giá trị**. ⚠️ Cá nhân giàu lên nhờ mua bán đất chỉ là **tiền chuyển từ túi người này sang người khác** (tiền làm *phương tiện thanh toán*, không phải thước đo giá trị mới) — cả xã hội **không** giàu lên nhờ chỉ mua bán đất. Đừng lẫn **giá trị** với **của cải**. |
| **Thương hiệu (danh tiếng)** | mua bán, định giá được, giá cả có khi rất cao — vì là kết quả **hao phí lao động** của nhiều người gây dựng. ⚠️ Nhưng chỉ có giá cao khi **dựa trên một nền sản xuất/dịch vụ thực**. |
...
| --- | --- |
| **Sản xuất hàng hóa** | tổ chức kinh tế sản xuất **để trao đổi, mua bán** (tr. 35) |
| **Hai điều kiện ra đời** | phân công lao động xã hội (cần) + tách biệt kinh tế/sở hữu (đủ) (tr. 35–36) |
| **Hàng hóa** | sản phẩm của lao động, thỏa mãn nhu cầu qua mua bán; vật thể / phi vật thể (tr. 37) |
| **Giá trị sử dụng** | công dụng của hàng hóa; phạm trù vĩnh viễn (tr. 37) |
| **Giá trị** | lao động xã hội kết tinh trong hàng hóa; phạm trù lịch sử (tr. 39) |
| **Giá trị trao đổi / giá cả** | hình thức biểu hiện của giá trị (bằng hàng / bằng tiền) (tr. 39, 49) |
| **Lao động cụ thể / trừu tượng** | tạo giá trị sử dụng (tính tư nhân) / tạo giá trị (tính xã hội) (tr. 40–41) |
| **Thời gian lao động xã hội cần thiết** | thời gian sản xuất ở điều kiện, trình độ, cường độ **trung bình** (tr. 43) |
| **Năng suất / cường độ lao động** | năng suất ↑ → giá trị đơn vị ↓ ; cường độ ↑ → giá trị đơn vị **không đổi** (tr. 43–44) |
| **Lao động giản đơn / phức tạp** | phức tạp = giản đơn **nhân bội**, tạo nhiều giá trị hơn (tr. 45) |
| **Tiền** | hàng hóa đặc biệt, vật ngang giá chung thống nhất (tr. 48) |
| **Tư bản giả** | chứng khoán, giấy tờ có giá — phân biệt với tư bản thực (tr. 55) |

---

## 8. Câu hỏi tự kiểm tra

1. **Sản xuất hàng hóa** là gì? Nêu **hai điều kiện** ra đời — đâu là điều kiện cần, đâu là điều kiện đủ?
2. **Hai thuộc tính** của hàng hóa? Phân biệt chặt **giá trị – giá trị trao đổi – giá cả**.
3. Qua ví dụ `xA = yB`, chứng minh vì sao "cái chung" của các hàng hóa là **giá trị** (lao động), không phải giá trị sử dụng.
4. **Tính hai mặt của lao động**: phân biệt lao động cụ thể/trừu tượng. Vì sao đây là **bước nhảy** của Mác so với Ricardo?
5. **Thời gian lao động xã hội cần thiết** là gì? Phân biệt tác động của **tăng năng suất** và **tăng cường độ** đến lượng giá trị (lấy ví dụ số).
6. Vì sao "**lao động phức tạp là lao động giản đơn nhân bội**"? Ý nghĩa với chính sách **thù lao**?
7. Trình bày **bốn hình thái giá trị** dẫn tới tiền. **Bản chất** của tiền là gì? Vì sao vàng làm được tiền?
8. Nêu **năm chức năng** của tiền. Vì sao chức năng lưu thông/thanh toán "tiềm ẩn khả năng khủng hoảng"?
9. Vì sao **quyền sử dụng đất, thương hiệu, chứng khoán** có giá cả mà không tạo giá trị như hàng hóa thường? "Tư bản giả" là gì?
...
```
BÀI 2 — HÀNG HÓA VÀ TIỀN TỆ (học thuyết giá trị)             (C2–I, tr. 35–55)
═══════════════════════════════════════════════════════════════════════════════
SẢN XUẤT HÀNG HÓA (để trao đổi) ra đời khi có 2 ĐIỀU KIỆN:
  ① PHÂN CÔNG LAO ĐỘNG XÃ HỘI (cần)  ② TÁCH BIỆT KINH TẾ/SỞ HỮU (đủ)

HÀNG HÓA có 2 THUỘC TÍNH:
  • GIÁ TRỊ SỬ DỤNG = công dụng (do lao động CỤ THỂ tạo; phạm trù VĨNH VIỄN)
  • GIÁ TRỊ = lao động xã hội kết tinh (do lao động TRỪU TƯỢNG tạo; phạm trù LỊCH SỬ)
  giá trị (nội dung) → giá trị trao đổi (bằng hàng) → GIÁ CẢ (bằng tiền)

TÍNH HAI MẶT CỦA LAO ĐỘNG (phát hiện của Mác, vượt Ricardo):
  lao động CỤ THỂ → giá trị sử dụng, tính TƯ NHÂN
  lao động TRỪU TƯỢNG → giá trị, tính XÃ HỘI
  mâu thuẫn tư nhân↔xã hội → hàng ế → KHỦNG HOẢNG tiềm ẩn

LƯỢNG GIÁ TRỊ = thời gian LAO ĐỘNG XÃ HỘI CẦN THIẾT (trung bình)
  3 nhân tố: ① NĂNG SUẤT (tỷ lệ NGHỊCH: NS↑→giá trị đơn vị↓, tổng KHÔNG đổi)
             ② CƯỜNG ĐỘ (giá trị đơn vị KHÔNG đổi, tổng↑ — như kéo dài thời gian)
             ③ PHỨC TẠP (phức tạp = giản đơn NHÂN BỘI, tạo nhiều giá trị hơn)

TIỀN: 4 hình thái giá trị: giản đơn → mở rộng → chung → TIỀN(vàng)
  bản chất = HÀNG HÓA ĐẶC BIỆT làm vật ngang giá chung (vàng có giá trị nên làm được tiền)
  5 chức năng: THƯỚC ĐO GIÁ TRỊ(→giá cả) · lưu thông · cất trữ · thanh toán · tiền thế giới

HÀNG HÓA ĐẶC BIỆT nay: dịch vụ(vô hình, không cất trữ) · quyền SD đất · thương hiệu ·
  chứng khoán = "TƯ BẢN GIẢ" (phải neo vào sản xuất thực); ⚠️ đừng lẫn GIÁ TRỊ với CỦA CẢI

💼 QTKD: thị trường tồn tại nhờ 2 điều kiện · công dụng≠giá trị (customer-centric) ·
   NS↑ = lợi thế chi phí (cày cường độ không hạ giá thành) · phức tạp→lương cao ·
   5 chức năng tiền = quản trị tài chính · thương hiệu/CK phải có "ruột" sản xuất thực
═══════════════════════════════════════════════════════════════════════════════
```
...
- **Giáo trình Kinh tế chính trị Mác – Lênin** (hệ không chuyên), Bộ GD&ĐT, NXB Chính trị Quốc gia Sự thật,
  Hà Nội, 2021 — **Chương 2, mục I** (tr. 35–55). [File gốc PDF](../tai_lieu/Giao-trinh-Kinh-te-chinh-tri-Mac-Lenin.pdf).
- Trích dẫn C. Mác theo bản dẫn của giáo trình (*Toàn tập*, NXB Chính trị Quốc gia: t.23, tr.69 và tr.72).
...
| **2** | **Hàng hóa và tiền tệ** ← *bạn đang ở đây* | C2 | 🎯 |
...
| 5 | [Tích lũy tư bản; lợi nhuận – lợi tức – địa tô](bai_05_tich_luy_va_loi_nhuan_dia_to.md) | C3 | 🎯⭐ |
