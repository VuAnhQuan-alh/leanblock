...
- [1. Bốn cuộc cách mạng công nghiệp](#1-bốn-cuộc-cách-mạng-công-nghiệp)
- [2. Công nghiệp hóa và ba mô hình tiêu biểu](#2-công-nghiệp-hóa-và-ba-mô-hình-tiêu-biểu)
- [3. Công nghiệp hóa, hiện đại hóa ở Việt Nam](#3-công-nghiệp-hóa-hiện-đại-hóa-ở-việt-nam)
- [4. Hội nhập kinh tế quốc tế: khái niệm, tất yếu, nội dung](#4-hội-nhập-kinh-tế-quốc-tế-khái-niệm-tất-yếu-nội-dung)
- [5. Tác động của hội nhập và nền kinh tế độc lập, tự chủ](#5-tác-động-của-hội-nhập-và-nền-kinh-tế-độc-lập-tự-chủ)
...
| --- | --- | --- |
| **CMCN 1.0** | giữa XVIII (Anh) | **cơ khí hóa** — máy hơi nước, cơ khí thay lao động thủ công |
| **CMCN 2.0** | cuối XIX – đầu XX | **điện khí hóa** — điện, động cơ điện, **dây chuyền sản xuất hàng loạt** |
| **CMCN 3.0** | nửa sau XX | **tự động hóa** — điện tử, tin học, công nghệ thông tin, tự động hóa |
| **CMCN 4.0** | đầu XXI (K. Schwab) | **số hóa** — kết nối vạn vật (IoT), dữ liệu lớn (Big Data), **trí tuệ nhân tạo (AI)**, in 3D, công nghệ sinh học; liên kết **vật lý – số – sinh học** |
...
| Mô hình | Cách làm | Kết quả |
| --- | --- | --- |
| **Cổ điển** (Anh, gắn CMCN 1.0) | từ **công nghiệp nhẹ (dệt)** → nặng; vốn từ **bóc lột lao động** + **cướp bóc thuộc địa** | thành công nhưng **chậm (60–80 năm)**, gây mâu thuẫn tư bản – lao động (→ sinh chủ nghĩa Mác) |
...
1. CNH là **quy luật phổ biến** của phát triển LLSX — mọi quốc gia đều trải qua; là đòn bẩy tạo đột phá.
2. Nước quá độ lên CNXH từ điểm xuất phát thấp như Việt Nam **phải xây cơ sở vật chất – kỹ thuật của CNXH từ đầu** qua CNH-HĐH.

**Bốn đặc điểm** (tr. 248): ① theo **định hướng XHCN** (mục tiêu *dân giàu, nước mạnh…*); ② gắn **phát triển kinh tế tri thức**; ③ trong điều kiện **KTTT định hướng XHCN**; ④ trong bối cảnh **toàn cầu hóa** và hội nhập.

**Nội dung** (tr. 249 trở đi):
...
## 5. Tác động của hội nhập và nền kinh tế độc lập, tự chủ

**Tác động hai mặt** (tr. 264–267):

| **Tích cực** | **Tiêu cực (thách thức)** |
| --- | --- |
| mở rộng **thị trường**, tiếp thu **KH–CN, vốn**, chuyển dịch cơ cấu kinh tế | **cạnh tranh gay gắt** → nhiều doanh nghiệp, ngành khó khăn, **phá sản** |
| nâng cao chất lượng **nguồn nhân lực** | **phụ thuộc** thị trường bên ngoài → dễ **tổn thương** trước biến động quốc tế |
| thúc đẩy hội nhập **văn hóa, chính trị**, củng cố **an ninh – quốc phòng** | **phân phối lợi ích không công bằng** → tăng khoảng cách giàu – nghèo |
| nâng cao **vị thế quốc tế** | nguy cơ **cơ cấu bất lợi** (thành "bãi thải công nghệ thấp", cạn tài nguyên); **xói mòn bản sắc văn hóa**; thách thức chủ quyền, an ninh |
...
| --- | --- |
| **Cách mạng công nghiệp** | bước nhảy vọt về chất của tư liệu lao động; 4 cuộc (cơ khí → điện → tự động → số) (tr. 225) |
| **Công nghiệp hóa** | chuyển từ lao động thủ công sang lao động máy móc, tăng năng suất (tr. 242) |
| **Ba mô hình CNH** | cổ điển (Anh) · kiểu Liên Xô · Nhật/NICs (rút ngắn) (tr. 242–245) |
| **CNH-HĐH** | chuyển đổi căn bản, toàn diện sang công nghệ tiên tiến, hiện đại (tr. 246) |
| **Kinh tế tri thức** | tri thức giữ vai trò quyết định; tri thức = LLSX trực tiếp (tr. 251) |
| **Hội nhập kinh tế quốc tế** | gắn kết kinh tế quốc gia với thế giới, chia sẻ lợi ích, tuân thủ chuẩn mực chung (tr. 260) |
| **Toàn cầu hóa kinh tế** | gia tăng liên kết, phụ thuộc lẫn nhau giữa các nền kinh tế (tr. 260) |
| **Mức độ hội nhập** | PTA → FTA → CU → thị trường chung → liên minh kinh tế – tiền tệ (tr. 263) |
| **Nền kinh tế độc lập, tự chủ** | không bị lệ thuộc, thao túng về đường lối, chính sách kinh tế (tr. 275) |

---

## 7. Câu hỏi tự kiểm tra

1. Kể **bốn cuộc cách mạng công nghiệp** và nội dung cốt lõi mỗi cuộc. Vai trò của chúng với phát triển?
2. **Công nghiệp hóa** là gì? Phân tích **ba mô hình** CNH tiêu biểu — mô hình nào là gợi ý cho Việt Nam, vì sao?
3. **CNH-HĐH** là gì? Vì sao là **tất yếu** ở Việt Nam? Nêu **bốn đặc điểm** và **nội dung** cơ bản.
4. **Kinh tế tri thức** là gì? Vì sao "tri thức trở thành lực lượng sản xuất trực tiếp"?
5. **Hội nhập kinh tế quốc tế** là gì? Vì sao là **tất yếu** trong bối cảnh toàn cầu hóa? Kể các **mức độ** hội nhập.
6. Phân tích **tác động tích cực** và **tiêu cực** của hội nhập kinh tế quốc tế với Việt Nam.
7. **Nền kinh tế độc lập, tự chủ** là gì? Vì sao "giữ độc lập, tự chủ đi đôi với chủ động hội nhập"?
...
```
BÀI 8 — CNH-HĐH VÀ HỘI NHẬP KINH TẾ QUỐC TẾ (bài KẾT)        (C6, tr. 224–290)
═══════════════════════════════════════════════════════════════════════════════
4 CÁCH MẠNG CÔNG NGHIỆP: 1.0 CƠ KHÍ(hơi nước) · 2.0 ĐIỆN(dây chuyền) ·
  3.0 TỰ ĐỘNG(điện tử-tin học) · 4.0 SỐ(IoT, Big Data, AI, sinh học)

CÔNG NGHIỆP HÓA = thủ công → MÁY MÓC (năng suất cao). 3 mô hình:
  CỔ ĐIỂN (Anh, nhẹ→nặng, cướp bóc thuộc địa, 60-80 năm)
  KIỂU LIÊN XÔ (ưu tiên công nghiệp NẶNG, kế hoạch hóa tập trung → sau trì trệ)
  NHẬT/NICs (CNH RÚT NGẮN, xuất khẩu, tận dụng KHCN đi trước, 20-30 năm) ← gợi ý cho VN

CNH-HĐH Ở VN: xây cơ sở vật chất-kỹ thuật của CNXH (tất yếu)
  4 đặc điểm: định hướng XHCN · gắn KINH TẾ TRI THỨC · trong KTTT định hướng XHCN · toàn cầu hóa
  nội dung: ① tạo lập điều kiện  ② chuyển đổi: ứng dụng KHCN mới, ưu tiên SX TƯ LIỆU SẢN XUẤT(Lênin),
             kinh tế tri thức, phát triển NHÂN LỰC
  KINH TẾ TRI THỨC (OECD): tri thức = LLSX TRỰC TIẾP

HỘI NHẬP KINH TẾ QUỐC TẾ = gắn kinh tế quốc gia với thế giới (chia sẻ lợi ích + chuẩn mực chung)
  tất yếu: xu thế TOÀN CẦU HÓA · phương thức phát triển phổ biến
  nội dung: chuẩn bị điều kiện (KHÔNG bằng mọi giá) · đa dạng hình thức/mức độ
  MỨC ĐỘ: PTA → FTA → CU(liên minh thuế quan) → thị trường chung → liên minh KT-tiền tệ

TÁC ĐỘNG hội nhập: tích cực (thị trường, KHCN, vốn, nhân lực, vị thế) /
  tiêu cực (cạnh tranh→phá sản · PHỤ THUỘC · phân hóa · cơ cấu bất lợi · xói mòn bản sắc)
  ⭐ GIỮ ĐỘC LẬP TỰ CHỦ đi đôi CHỦ ĐỘNG HỘI NHẬP (không đóng cửa, không hòa tan)

💼 QTKD: mỗi CMCN đẻ mô hình KD mới · latecomer/leapfrogging · chuyển đổi số + đầu tư con người ·
   tận dụng FTA (CPTPP/EVFTA) · nâng năng lực cạnh tranh thật · đa dạng hóa chuỗi cung ứng/thị trường
═══════════════════════════════════════════════════════════════════════════════
```
...
- **Giáo trình Kinh tế chính trị Mác – Lênin** (hệ không chuyên), Bộ GD&ĐT, NXB Chính trị Quốc gia Sự thật,
  Hà Nội, 2021 — **Chương 6** (tr. 224–290). [File gốc PDF](../tai_lieu/Giao-trinh-Kinh-te-chinh-tri-Mac-Lenin.pdf).
- Trích dẫn V.I. Lênin (*Toàn tập*, t.45, tr.XVIII), K. Schwab, J. Stiglitz, OECD theo bản dẫn của giáo trình.
...
| **8** | **Công nghiệp hóa, hiện đại hóa và hội nhập kinh tế** ← *bạn đang ở đây* | C6 | 🔸 |
