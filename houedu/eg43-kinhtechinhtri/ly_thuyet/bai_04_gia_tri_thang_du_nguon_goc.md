...
- [1. Công thức chung của tư bản và mâu thuẫn của nó](#1-công-thức-chung-của-tư-bản-và-mâu-thuẫn-của-nó)
- [2. Hàng hóa sức lao động — chìa khóa](#2-hàng-hóa-sức-lao-động--chìa-khóa)
- [3. Quá trình sản xuất giá trị thặng dư (ví dụ kéo sợi)](#3-quá-trình-sản-xuất-giá-trị-thặng-dư-ví-dụ-kéo-sợi)
- [4. Tư bản bất biến, khả biến và tiền công](#4-tư-bản-bất-biến-khả-biến-và-tiền-công)
- [5. Tỷ suất và khối lượng giá trị thặng dư](#5-tỷ-suất-và-khối-lượng-giá-trị-thặng-dư)
- [6. Bản chất của giá trị thặng dư](#6-bản-chất-của-giá-trị-thặng-dư)
- [7. Hai phương pháp sản xuất giá trị thặng dư](#7-hai-phương-pháp-sản-xuất-giá-trị-thặng-dư)
- [8. Tuần hoàn và chu chuyển của tư bản](#8-tuần-hoàn-và-chu-chuyển-của-tư-bản)
...
So sánh hai kiểu vận động của tiền (tr. 85):

```
Lưu thông hàng hóa GIẢN ĐƠN:   H – T – H
     (bán hàng lấy tiền, rồi mua hàng khác;  MỤC ĐÍCH = giá trị SỬ DỤNG)
Lưu thông TƯ BẢN:              T – H – T'
     (bỏ tiền mua hàng, bán lấy tiền NHIỀU HƠN;  MỤC ĐÍCH = giá trị LỚN HƠN)
     với  T' = T + Δt   (Δt > 0)
```
...
1. Người lao động **được tự do về thân thể** (tự do bán sức lao động của mình).
2. Người lao động **không có đủ tư liệu sản xuất** → buộc phải bán sức lao động để sống.

**Hai thuộc tính** của hàng hóa sức lao động (tr. 87):
...
## 3. Quá trình sản xuất giá trị thặng dư (ví dụ kéo sợi)

Đây là ví dụ kinh điển của sách (tr. 88–90). Giả định nhà tư bản kéo sợi, thuê 1 công nhân, ngày làm **8 giờ**, đã thỏa thuận trả **15 USD** cho cả ngày (đúng giá trị sức lao động).

**Giả định thêm:** trong **4 giờ**, công nhân biến 50 kg bông thành sợi.

```
▸ 4 GIỜ ĐẦU — nhà tư bản ứng:
   50 kg bông ............................. 50 USD  (c: chuyển vào)
   hao mòn máy móc .........................  3 USD  (c: chuyển vào)
   giá trị mới do lao động tạo (= tiền công) 15 USD  (v+m? — xem dưới)
   ─────────────────────────────────────────────────
   Giá trị sợi (4h đầu) .................... 68 USD
   → Nếu DỪNG ở đây: ứng 68, thu 68 → KHÔNG có thặng dư, tiền chưa thành tư bản.

   Mấu chốt: 15 USD mua sức lao động cho CẢ 8 GIỜ, không phải 4 giờ.
   Trong 4h đầu, công nhân đã tạo 15 USD giá trị mới = ĐỦ bù tiền công.
   → 4h đầu = THỜI GIAN LAO ĐỘNG TẤT YẾU.

▸ 4 GIỜ SAU — công nhân làm tiếp; nhà tư bản chỉ bỏ THÊM:
   50 kg bông ............................. 50 USD
   hao mòn máy móc .........................  3 USD
   giá trị mới tạo thêm .................... 15 USD  ← KHÔNG phải trả thêm tiền công!
   ─────────────────────────────────────────────────
   Giá trị sợi (4h sau) .................... 68 USD
   → 4h sau = THỜI GIAN LAO ĐỘNG THẶNG DƯ (làm không công cho nhà tư bản).
```

**Kết toán cả ngày 8 giờ:**

| Khoản | Ứng ra | Giá trị sợi thu |
| --- | ---: | ---: |
| Bông (100 kg) | 100 | 100 |
| Hao mòn máy (2 × 3) | 6 | 6 |
| Sức lao động | 15 | — |
...
## 4. Tư bản bất biến, khả biến và tiền công

Để chỉ rõ **lao động** (không phải máy móc) mới tạo thặng dư, Mác chia tư bản theo **vai trò trong việc tạo giá trị** (tr. 92–93):

| | **Tư bản bất biến `c`** | **Tư bản khả biến `v`** |
| --- | --- | --- |
| Tồn tại dưới dạng | **tư liệu sản xuất** (máy móc, nguyên – nhiên – vật liệu) | **sức lao động** |
...
Nhà tư bản không chỉ muốn *có* `m` mà muốn **nhiều** `m`, nên cần thước đo (tr. 99–100):

**Tỷ suất giá trị thặng dư `m′`** — phản ánh **trình độ khai thác** sức lao động:

$$m' = \dfrac{m}{v} \times 100\% = \dfrac{t'}{t} \times 100\%$$

(với `t'` = thời gian lao động thặng dư, `t` = thời gian lao động tất yếu). Ví dụ kéo sợi: `m′ = 15/15 × 100% = 100%` — tức mỗi giờ làm cho mình thì có một giờ làm không công cho chủ.

**Khối lượng giá trị thặng dư `M`** — phản ánh **quy mô** bóc lột:
...
Muốn nhiều `m`, nhà tư bản dùng **hai phương pháp** (tr. 101–103):
...
```
GỐC:  ngày 8h = 4h tất yếu + 4h thặng dư  →  m′ = 4/4 = 100%
KÉO DÀI thêm 2h → ngày 10h = 4h tất yếu + 6h thặng dư
                  →  m′ = 6/4 × 100% = 150%
```
...
```
GỐC:  ngày 8h = 4h tất yếu + 4h thặng dư  →  m′ = 100%
NĂNG SUẤT ↑ → tất yếu còn 2h → thặng dư 6h  →  m′ = 6/2 × 100% = 300%
...
## 8. Tuần hoàn và chu chuyển của tư bản

**Tuần hoàn** — tư bản đi qua **ba giai đoạn** dưới **ba hình thái** rồi quay về kèm `m` (tr. 95):
...
(`n` = số vòng/năm; `CH` = thời gian 1 năm; `ch` = thời gian 1 vòng). Chia theo cách chuyển giá trị:
...
| --- | --- |
| **Công thức chung của tư bản** | `T – H – T'`, với `T' = T + Δt` (Δt = giá trị thặng dư) (tr. 85) |
| **Tư bản** | giá trị mang lại giá trị thặng dư (tr. 85) |
| **Hàng hóa sức lao động** | năng lực lao động; 2 điều kiện (tự do thân thể + không có TLSX) (tr. 86) |
| **Giá trị sức lao động** | = tư liệu sinh hoạt + phí đào tạo + nuôi con (tr. 87) |
| **Giá trị sử dụng của sức lao động** | đặc biệt: tạo ra giá trị **lớn hơn** bản thân → chìa khóa (tr. 87) |
| **Thời gian lao động tất yếu / thặng dư** | phần bù giá trị sức lao động / phần dôi ra tạo `m` (tr. 88) |
| **Giá trị thặng dư `m`** | giá trị dôi ra ngoài giá trị sức lao động; lao động không công (tr. 90) |
| **Tư bản bất biến `c` / khả biến `v`** | TLSX (không sinh `m`) / sức lao động (sinh `m`); `G = c + v + m` (tr. 92–93) |
| **Tiền công** | giá cả của hàng hóa sức lao động (tr. 94) |
| **Tỷ suất `m′` / khối lượng `M`** | `m′ = m/v ×100%` (trình độ khai thác) / `M = m′·V` (quy mô) (tr. 100) |
| **GTTD tuyệt đối / tương đối** | kéo dài ngày lao động / rút ngắn thời gian tất yếu bằng tăng năng suất (tr. 101–102) |
| **GTTD siêu ngạch** | phần trội của người có năng suất cá biệt cao; biến tướng của GTTD tương đối (tr. 103) |
| **Tuần hoàn / chu chuyển** | 3 hình thái (tiền – sản xuất – hàng hóa) / lặp lại định kỳ, `n = CH/ch` (tr. 95–96) |
| **Tư bản cố định / lưu động** | chuyển giá trị dần / một lần; hao mòn hữu hình & vô hình (tr. 97) |

---

## 10. Câu hỏi tự kiểm tra

1. So sánh `H–T–H` và `T–H–T'`. Vì sao `T–H–T'` là **công thức chung của tư bản**? **Mâu thuẫn** của nó là gì?
2. **Hai điều kiện** để sức lao động thành hàng hóa? **Hai thuộc tính** của nó? Vì sao giá trị sử dụng của sức lao động là "chìa khóa"?
3. Trình bày **ví dụ kéo sợi**: chỉ rõ thời gian tất yếu, thời gian thặng dư, và tính ra `m = 15 USD`.
4. Phân biệt **tư bản bất biến `c`** và **khả biến `v`**. Vì sao chỉ `v` tạo `m`? Viết công thức `G = c + v + m`.
5. **Tiền công** thực chất là gì? Vì sao dễ gây "ngộ nhận"?
6. ⭐ Viết công thức **tỷ suất `m′`** và **khối lượng `M`**. `m′` và `M` phản ánh điều gì khác nhau?
7. **Bản chất** của giá trị thặng dư? Vì sao "bóc lột" mà "không vi phạm trao đổi ngang giá"?
8. Phân biệt **GTTD tuyệt đối** và **tương đối** (kèm ví dụ số `m′`). **GTTD siêu ngạch** là gì, vì sao là động lực đổi mới?
9. Trình bày **tuần hoàn** (3 hình thái) và **chu chuyển** của tư bản. Phân biệt tư bản cố định / lưu động; hao mòn hữu hình / vô hình.
...
```
BÀI 4 — GIÁ TRỊ THẶNG DƯ: NGUỒN GỐC ⭐                       (C3–I, tr. 85–103)
═══════════════════════════════════════════════════════════════════════════════
CÔNG THỨC CHUNG CỦA TƯ BẢN:  T – H – T'  (T' = T + Δt, Δt = m)
  mâu thuẫn: lưu thông KHÔNG tạo giá trị mới → nhưng m vẫn "trội ra"
  LỜI GIẢI = HÀNG HÓA SỨC LAO ĐỘNG (dùng nó tạo giá trị LỚN HƠN bản thân)

HÀNG HÓA SỨC LAO ĐỘNG: 2 điều kiện (tự do thân thể + không có TLSX)
  • GIÁ TRỊ = tư liệu sinh hoạt + phí đào tạo + nuôi con
  • GIÁ TRỊ SỬ DỤNG (đặc biệt) = tạo giá trị mới > giá trị bản thân  ← CHÌA KHÓA

VÍ DỤ KÉO SỢI (ngày 8h, công 15 USD):
  ứng: bông 100 + máy 6 + sức lao động 15 = 121 USD
  thu: giá trị sợi = 136 USD  →  m = 136 − 121 = 15 USD
  4h đầu = TẤT YẾU (bù công) · 4h sau = THẶNG DƯ (không công)
  nhà tư bản KHÔNG vi phạm ngang giá (trả đủ 15 = giá trị sức lao động)

TƯ BẢN: c (bất biến, TLSX, KHÔNG sinh m) · v (khả biến, sức lao động, SINH m)
  G = c + (v + m)   ;   tiền công = giá cả sức lao động
TỶ SUẤT  m' = m/v ×100% = t'/t ×100%  (trình độ khai thác) → vd 100%
KHỐI LƯỢNG  M = m'·V  (quy mô)
BẢN CHẤT = quan hệ giai cấp (BÓC LỘT dù không vi phạm ngang giá; do lao động SỐNG)

2 PHƯƠNG PHÁP:
  • TUYỆT ĐỐI = kéo dài ngày lao động (8h→10h: m'=150%); ⚠️ có TRẦN sinh lý
  • TƯƠNG ĐỐI = tăng NĂNG SUẤT → rút ngắn tất yếu (m'=300%, 500%)
  • SIÊU NGẠCH = phần trội của người đi trước (động lực đổi mới; biến tướng của tương đối)

TUẦN HOÀN: tiền → sản xuất → hàng hóa (m sinh trong SẢN XUẤT, thực hiện khi BÁN được)
CHU CHUYỂN: n = CH/ch ; tư bản CỐ ĐỊNH (chuyển dần, hao mòn hữu hình+vô hình) / LƯU ĐỘNG (một lần)

💼 QTKD: lợi nhuận bền = sản xuất, không phải mua rẻ bán đắt · con người là tài sản SINH giá trị ·
   ví dụ kéo sợi = P&L · m'~biên/lao động, M~tổng lợi nhuận · máy = c (tự động hóa đổi cơ cấu c/v) ·
   tăng năng suất > cày giờ · siêu ngạch = first-mover premium · n = vòng quay vốn · hao mòn vô hình
═══════════════════════════════════════════════════════════════════════════════
```
...
- **Giáo trình Kinh tế chính trị Mác – Lênin** (hệ không chuyên), Bộ GD&ĐT, NXB Chính trị Quốc gia Sự thật,
  Hà Nội, 2021 — **Chương 3, mục I** (tr. 85–103). [File gốc PDF](../tai_lieu/Giao-trinh-Kinh-te-chinh-tri-Mac-Lenin.pdf).
- Trích dẫn C. Mác theo bản dẫn của giáo trình (*Toàn tập*, NXB Chính trị Quốc gia: t.23, tr.251).
...
| **4** | **Giá trị thặng dư — nguồn gốc** ← *bạn đang ở đây* | C3 | 🎯⭐ |
